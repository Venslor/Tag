...
public final class CC {
    ...
    public static List<String> translate(List<String> message) {
        return (List)message.stream().map(CC::translate).collect(Collectors.toList());
    }
    ...
    static {
        ...
        UNICODE_VERTICAL_BAR = GRAY + StringEscapeUtils.unescapeJava("┃");
        ...
        MEDIUM_CHAT_BAR = ChatColor.GRAY + ChatColor.STRIKETHROUGH.toString() + "------------------------------";
    }
}