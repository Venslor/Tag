...
public abstract class Menu {
    ...
    public void update(Player player) {
        ...
        if (currentlyOpenedMenu != null && Color.translate(currentlyOpenedMenu.getName(player)).equals(current.getTitle())/* && current.getSize() == this.getInventorySize(this.slots)*/) {
            inventory = current;
            passed = true;
        }
